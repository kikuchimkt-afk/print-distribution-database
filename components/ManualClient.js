  ...
  },
  {
    ...
    content: [
      ...
      { type: 'steps', value: [
        ...
        { emoji: '4️⃣', text: 'ファイル選択：全生徒のスロットから選択 or 新規アップロード' },
        { emoji: '5️⃣', text: '選択した全生徒に同じ宿題・ファイルが配信されます' },
      ]},
      { type: 'tip', value: '一括配信でも「📋 既存スロット」タブから他の生徒のPDFを選択できます。共通教材の配信に便利です。' },
    ],
  },
  {
    id: 'qr',
    ...
    content: [
      ...
      { type: 'heading', value: '生徒用LP（宿題連絡帳）の機能' },
      { type: 'text', value: '生徒のLP（宿題ページ）には以下の機能があります：' },
      { type: 'steps', value: [
        { emoji: '🌲', text: '森テーマのデザイン — フクロウ家族が住む森の背景' },
        { emoji: '⏱', text: '経過時間タイマー — ページを開いた時間を表示' },
        { emoji: '✅', text: '「勉強終了」ボタン — 生徒が押すと閲覧時間が記録される' },
        { emoji: '📖', text: '使い方ガイド — LP内にモーダルで表示' },
      ]},
    ],
  },
  {
    ...
    content: [
      ...
      { type: 'heading', value: '記録のタイミング' },
      { type: 'steps', value: [
        { emoji: '👁', text: '初見 — ページを初めて開いた時点で自動記録' },
        { emoji: '✅', text: '最終閲覧 — 生徒が「勉強終了」ボタンを押した時に記録' },
        { emoji: '⏱', text: '自動記録 — 15分以上ページを閲覧した場合も自動で記録' },
      ]},
      { type: 'heading', value: '表示されるバッジ' },
      { type: 'badges', value: [
        { label: '👁 初見：4/13 13:05', color: 'viewed', desc: 'ページを初めて開いた日時' },
        { label: '🕐 最終：4/13 15:20', color: '', desc: '勉強終了ボタンを押した or 15分以上閲覧した最終日時' },
        { label: '未閲覧', color: 'unviewed', desc: 'まだページを開いていない' },
      ]},
      { type: 'tip', value: '生徒には「勉強終了」ボタンが表示されていますが、15分の自動記録については知りません。ボタンを押さなくても15分以上滞在すれば記録されます。' },
    ],
  },
];
...
const STUDENT_SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'steps', value: [
        { emoji: '⏱', text: 'ページを開くとタイマーが自動スタート' },
        { emoji: '📖', text: '宿題を確認・PDFを閲覧しながら勉強' },
        { emoji: '✅', text: '終わったら「勉強終了」ボタンをタップ' },
      ]},
